		...
		$wigets_arr = $wigetsHandler->getall($criteria);
			...
			{			
				...
				{	
					...
					if( $online == 1 ) {
						echo "<td align=\"center\"><a href=\"./wigets.php?op=update_online_wigets&wigets_id=".$wigets_arr[$i]->getVar("wigets_id")."&wigets_online=0\"><img src=\"./../images/deco/1.png\" border=\"0\" alt=\""._AM_IXTFRAMEWORK_ON."\" title=\""._AM_IXTFRAMEWORK_ON."\"></a></td>";	
					} else {
						echo "<td align=\"center\"><a href=\"./wigets.php?op=update_online_wigets&wigets_id=".$wigets_arr[$i]->getVar("wigets_id")."&wigets_online=1\"><img src=\"./../images/deco/0.png\" border=\"0\" alt=\""._AM_IXTFRAMEWORK_OFF."\" title=\""._AM_IXTFRAMEWORK_OFF."\"></a></td>";
					}
									echo "<td align=\"center\" width=\"10%\">
										<a href=\"wigets.php?op=edit_wigets&wigets_id=".$wigets_arr[$i]->getVar("wigets_id")."\"><img src=\"../images/deco/edit.png\" alt=\""._AM_IXTFRAMEWORK_EDIT."\" title=\""._AM_IXTFRAMEWORK_EDIT."\"></a>
										<a href=\"wigets.php?op=delete_wigets&wigets_id=".$wigets_arr[$i]->getVar("wigets_id")."\"><img src=\"../images/deco/delete.png\" alt=\""._AM_IXTFRAMEWORK_DELETE."\" title=\""._AM_IXTFRAMEWORK_DELETE."\"></a>
									  </td>";
						echo "</tr>";
					}	
				}
