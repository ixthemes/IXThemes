		...
		$uitheme_arr = $uithemeHandler->getall($criteria);
			...
			{			
				...
				{	
					...
					if( $online == 1 ) {
						echo "<td align=\"center\"><a href=\"./uitheme.php?op=update_online_uitheme&uitheme_id=".$uitheme_arr[$i]->getVar("uitheme_id")."&uitheme_online=0\"><img src=\"./../images/deco/on.gif\" border=\"0\" alt=\""._AM_IXTFRAMEWORK_ON."\" title=\""._AM_IXTFRAMEWORK_ON."\"></a></td>";	
					} else {
						echo "<td align=\"center\"><a href=\"./uitheme.php?op=update_online_uitheme&uitheme_id=".$uitheme_arr[$i]->getVar("uitheme_id")."&uitheme_online=1\"><img src=\"./../images/deco/off.gif\" border=\"0\" alt=\""._AM_IXTFRAMEWORK_OFF."\" title=\""._AM_IXTFRAMEWORK_OFF."\"></a></td>";
					}
									echo "<td align=\"center\" width=\"10%\">
										<a href=\"uitheme.php?op=edit_uitheme&uitheme_id=".$uitheme_arr[$i]->getVar("uitheme_id")."\"><img src=\"../images/deco/edit.gif\" alt=\""._AM_IXTFRAMEWORK_EDIT."\" title=\""._AM_IXTFRAMEWORK_EDIT."\"></a>
										<a href=\"uitheme.php?op=delete_uitheme&uitheme_id=".$uitheme_arr[$i]->getVar("uitheme_id")."\"><img src=\"../images/deco/delete.gif\" alt=\""._AM_IXTFRAMEWORK_DELETE."\" title=\""._AM_IXTFRAMEWORK_DELETE."\"></a>
									  </td>";
						echo "</tr>";
					}	
				}
