...
if (!ixtframework_isrmcommon()) {
	...
	ixtframework_adminmenu(6, _AM_IXTFRAMEWORK_MANAGER_WIDGETS);
	} else {
	include_once XOOPS_ROOT_PATH."/Frameworks/art/functions.admin.php";
	loadModuleAdminMenu (6, _AM_IXTFRAMEWORK_MANAGER_WIDGETS);
	}
} else {
...
{	
	...
	default:
        ...
        if (class_exists("XoopsPersistableObjectHandler")) {
		 ...
		 $widgets_arr = $widgetsHandler->getObjects($criteria, false, true);
		}
