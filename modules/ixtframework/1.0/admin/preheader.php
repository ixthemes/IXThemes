...
if (!ixtframework_isrmcommon()) {
	...
	ixtframework_adminmenu(8, _AM_IXTFRAMEWORK_MANAGER_PREHEADER);
	} else {
	include_once XOOPS_ROOT_PATH."/Frameworks/art/functions.admin.php";
	loadModuleAdminMenu (8, _AM_IXTFRAMEWORK_MANAGER_PREHEADER);
	}
} else {
...
{	
	...
	default:
        ...
        if (class_exists("XoopsPersistableObjectHandler")) {
		 ...
		 $preheader_arr = $preheaderHandler->getObjects($criteria, false, true);
		}
