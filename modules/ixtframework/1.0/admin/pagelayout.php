...
if (!ixtframework_isrmcommon()) {
	...
	ixtframework_adminmenu(4, _AM_IXTFRAMEWORK_MANAGER_PAGELAYOUT);
	} else {
	include_once XOOPS_ROOT_PATH."/Frameworks/art/functions.admin.php";
	loadModuleAdminMenu (4, _AM_IXTFRAMEWORK_MANAGER_PAGELAYOUT);
	}
} else {
...
{	
	...
	default:
        ...
        if (class_exists("XoopsPersistableObjectHandler")) {
		 ...
		 $pagelayout_arr = $pagelayoutHandler->getObjects($criteria, false, true);
		}
