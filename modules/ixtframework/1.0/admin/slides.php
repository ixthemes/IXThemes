		...
		$slides_arr = $slidesHandler->getall($criteria);
			...
			{			
				...
				{	
					...
					if( $online == 1 ) {
						echo "<td align=\"center\"><a href=\"./slides.php?op=update_online_slides&slides_id=".$slides_arr[$i]->getVar("slides_id")."&slides_online=0\"><img src=\"./../images/deco/on.gif\" border=\"0\" alt=\""._AM_IXTFRAMEWORK_ON."\" title=\""._AM_IXTFRAMEWORK_ON."\"></a></td>";	
					} else {
						echo "<td align=\"center\"><a href=\"./slides.php?op=update_online_slides&slides_id=".$slides_arr[$i]->getVar("slides_id")."&slides_online=1\"><img src=\"./../images/deco/off.gif\" border=\"0\" alt=\""._AM_IXTFRAMEWORK_OFF."\" title=\""._AM_IXTFRAMEWORK_OFF."\"></a></td>";
					}
									echo "<td align=\"center\" width=\"10%\">
										<a href=\"slides.php?op=edit_slides&slides_id=".$slides_arr[$i]->getVar("slides_id")."\"><img src=\"../images/deco/edit.gif\" alt=\""._AM_IXTFRAMEWORK_EDIT."\" title=\""._AM_IXTFRAMEWORK_EDIT."\"></a>
										<a href=\"slides.php?op=delete_slides&slides_id=".$slides_arr[$i]->getVar("slides_id")."\"><img src=\"../images/deco/delete.gif\" alt=\""._AM_IXTFRAMEWORK_DELETE."\" title=\""._AM_IXTFRAMEWORK_DELETE."\"></a>
									  </td>";
						echo "</tr>";
					}	
				}
