...
if (!ixtframework_isrmcommon()) {
	...
	ixtframework_adminmenu(10, _AM_IXTFRAMEWORK_MANAGER_BOTLAYOUT);
	} else {
	include_once XOOPS_ROOT_PATH."/Frameworks/art/functions.admin.php";
	loadModuleAdminMenu (10, _AM_IXTFRAMEWORK_MANAGER_BOTLAYOUT);
	}
} else {
...
{	
	...
	default:
        ...
        if (class_exists("XoopsPersistableObjectHandler")) {
		 ...
		 $botlayout_arr = $botlayoutHandler->getObjects($criteria, false, true);
		}
