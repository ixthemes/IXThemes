...
class IxtcakeCorePreload extends XoopsPreloadItem
{
	function eventIxtcakeAdmin($args)
	{
		$GLOBALS['xoTheme']->addStylesheet('modules/ixtcake/css/tooltip.css');
		$GLOBALS['xoTheme']->addStylesheet('modules/ixtcake/css/prettyPhoto.css');
		$GLOBALS['xoTheme']->addScript('browse.php?Frameworks/jquery/jquery.js');
		if (!(is_file(XOOPS_TRUST_PATH . "/Frameworks/jquery/plugins/jquery.jgrowl.js"))) {
			// it is XOOPS 2.4.x
			$GLOBALS['xoTheme']->addScript('browse.php?modules/ixtcake/js/jquery.jgrowl.js');
			$GLOBALS['xoTheme']->addStylesheet('modules/ixtcake/css/jgrowl.css');
		} else {
		...
		if (!(is_file(XOOPS_TRUST_PATH . "/Frameworks/jquery/plugins/jquery.prettyPhoto.js"))) {
			$GLOBALS['xoTheme']->addScript('browse.php?modules/ixtcake/js/jquery.prettyPhoto.js');
		} else {
	...
	function eventIxtcakeJgrowlredirect($args)
	{
